...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            logging.info("Evaluating sklearn models using GridSearchCV")
            ...
            # -------------------------------
            logging.info("Training CatBoostRegressor separately")
            ...
            model_report["CatBoosting Regressor"] = cat_score
